...
var studentCount = 16;
var mentorCount = 9;
var moreStudentsThanMentors = studentCount > mentorCount ? true : false; 

var roomMaxCapacity = 25;
var enoughSpaceInRoom  = (Number(studentCount)) + (Number(mentorCount)) <= 25 ? true : false; 

var personA = "Daniel";
var personB = "Irina";
var sameName  = (personA === personB) ? true : false; 
